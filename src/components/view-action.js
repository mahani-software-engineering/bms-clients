...
function ViewAction(props) {
                ...
                if (response.data.Data){
                    if(Array.isArray(response.data.Data)){
                        ...
                        if(rowsCount > 0){
                            ...
                            let colnames = Object.keys(dataSingleRow).filter(ky=>((typeof dataSingleRow[ky]) !== "object" && (!blacklistedColms.includes(ky.toLowerCase())) ));
    ...
    function loadAddForm () {
        ...
        if(props.endpoint.includes("payment") || props.endpoint.includes("Payment")){
          ...
          props.updateActiveDisplay(<Form endpoint={props.endpoint} epcase={props.epcase?props.epcase:1} vwcase={props.vwcase} updateActiveDisplay={props.updateActiveDisplay}/>);
        }
    }
    ...
    return (
                ...
                <thead className="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
                    <tr>
                        ...
                        <th className="p-2 whitespace-nowrap">
                            <button className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow" onClick={loadAddForm}>
                              New +
                            </button>
                        </th>
                    </tr>
                     ...
                     dataFromBackend.map((rowval, rowIndex) => <tr key={rowIndex}>
                        ...
                        <td className="p-2 whitespace-nowrap" style={{textAlign:"right"}}>
                            <div className="text-lg text-center"> 
                               <ActionsBtn endpoint={props.endpoint} epcase={props.epcase} vwcase="single" updateActiveDisplay={props.updateActiveDisplay}/>                 
                            </div>
                        </td>
                     </tr>
                   ) /////////////
        ...
        :props.vwcase === "single" ?
         ...
         <div className="flex flex-row flex-wrap flex-grow mt-2">
            <div className="border-b p-3 flex items-center justify-between" style={{paddingRight: "0"}}>
                <button className="inline-flex items-center px-6 py-2 text-sm text-gray-800 rounded-lg shadow outline-none gap-x-1 hover:bg-gray-100" style={{background:"linen"}}>       
            ...
            <div className="p-5">
                <table className="table-auto w-full">    
                    <tbody className="text-sm divide-y divide-gray-100">
                     {
                       dataFromBackend.map((pair, index) => {
                       <tr>
